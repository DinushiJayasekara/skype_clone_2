...
// import 'package:skype_clone/provider/member_provider.dart';
// import 'package:skype_clone/resources/call_methods.dart';
import 'package:skype_clone_2/configs/agora_configs.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  void _addAgoraEventHandlers() {
    ...
    AgoraRtcEngine.onFirstRemoteVideoFrame = (
      ...
      setState(() {
        final info = 'onFirstRemoteVideoFrame: $uid ${width}x$height';
        _infoStrings.add(info);
      });
    };
  }
  ...
  addPostFrameCallback() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      callStreamSubscription = callMethods
          .callStream(uid: memberProvider.getMember.uid)
  ...
  List<Widget> _getRenderViews() {
    ...
    // if (widget.call.role == ClientRole.Broadcaster) {
  ...
  // Toolbar layout
  Widget _toolbar() {
    // if (widget.call.role == ClientRole.Audience) return Container();
    return Container(
